...
export default function AddExpense({ onAdd, initialDate }) {
  ...
  return (
    <div className="flex flex-col flex-1 min-h-0 px-6 pt-6">
      ...
      {/* Date chip — native picker sits transparently on top so iOS/Android
          open their own wheel instead of us reimplementing a calendar. */}
        ...
        <div className="relative">
          <div
            ...
            style={{
              ...
              background: backdated ? 'var(--accent-glow)' : 'var(--bg-surface)',
              border: `1px solid ${backdated ? 'var(--accent)' : 'var(--border-muted)'}`,
              color: backdated ? 'var(--accent)' : 'var(--text-secondary)',
            }}
          >
